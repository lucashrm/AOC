========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet DEV_CIAO
========================================================================

AppWizard a créé cette application DEV_CIAO pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application DEV_CIAO.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé DEV_CIAO.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
