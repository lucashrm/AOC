...
extern MYLIBRARY_EXPORT int     mq_close(mqd_t);
extern MYLIBRARY_EXPORT int     mq_getattr(mqd_t, struct mq_attr *);
extern MYLIBRARY_EXPORT int     mq_notify(mqd_t, const struct sigevent *);
extern MYLIBRARY_EXPORT mqd_t   mq_open(const char *, int, ...);
extern MYLIBRARY_EXPORT ssize_t mq_receive(mqd_t, char *, size_t, unsigned int *);
extern MYLIBRARY_EXPORT int     mq_send(mqd_t, const char *, size_t, unsigned int);
extern MYLIBRARY_EXPORT int     mq_setattr(mqd_t, const struct mq_attr *, struct mq_attr *);
extern MYLIBRARY_EXPORT int     mq_unlink(const char *name);

MYLIBRARY_EXPORT ssize_t        mq_timedreceive(mqd_t mqdes, char *msg_ptr,
