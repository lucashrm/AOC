...
class pyg_button:
    ...
    ------------------------------------------------ '''
    def __init__(self, container, t1, label):
...
# ==================================================
class pyg_label:
    def __init__(self, container, t1, text, fontsize=False):
        xc, yc = t1
        self.xc, self.yc = xc, yc
        if not fontsize:
            fontsize = 28
...
class pyg_cursor:
    ...
    ------------------------------------------------ '''
    def __init__(self, container, t1, active=False):
        xc, yc, hh, ww = t1
        # =====================
...
class pygplot:
    ...
    # --------------------------------------------------------------
    def updt_plot(self, t1, PLT_CLR, LW=False, DECORATE=False, RANGE=False):
        xx, yy = t1
        XW = self.XW
        YW = self.YW
